...
N = int(input('укажите в грядку с каким номером устанавливается модуль '))
result = garden[N - 1] + garden[N - 2] + garden[N]
print(f'с этих куств можно собрать {result} ягод')
